...
from langchain.embeddings import TransformersEmbeddings
import os
...
embeddings = TransformersEmbeddings(model, tokenizer)
...
response_chain = LLMChain(llm=model, prompt=response_prompt_template)
...
location_chain = LLMChain(llm=model, prompt=location_prompt_template)
