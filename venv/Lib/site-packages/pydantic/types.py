...
class Tag:
    ...
    apple_variation = ThanksgivingDinner.model_validate(
        {'dessert': {'fruit': 'apple', 'time_to_cook': 60, 'num_near_places': 8}}
    )
    print(repr(apple_variation))
    '''
    ThanksgivingDinner(dessert=ApplePie(time_to_cook=60, num_near_places=8, fruit='apple'))
    '''
    ...
    '''
    ThanksgivingDinner(dessert=PumpkinPie(time_to_cook=40, num_near_places=6, filling='pumpkin'))
    '''
    ```
